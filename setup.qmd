...
## Step 5: Generate a Token in GitHub 

Go to https://github.com/settings/tokens. Under "Generate New Token" choose the "Classic" option. Name the token something useful like "2024-r-for-ed-class". 
...
You can read more about GitHub tokens [here](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens).

## Step 6: Setting up RStudio for Cloning GitHub respositories 

Once you have confirmed Git is working on your machine, copy and paste the following code in the "Console" pane and run it by hitting return. 
