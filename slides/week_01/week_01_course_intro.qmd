...
summer24 <- tibble(STUSPS = c("VA", "AZ", "AK", "DC", "NC", 
                              "PA", "DE", "AL", "MI", "GA","NY",
                              "MS",
                              "CO","CA", "IL", "IN",
                              "OH", "MN","TN", "FL"),
...
|:----:|------------|------------------------------------------------|
|  01  | June 4     | Introduction to education finance equity and R |
|  02  | June 11    | Basic data analysis and visualization in R     |
|  03  | June 18    | Deep-dive on education finance policy          |
|  04  | June 25    | Data cleaning and processing in R              |
|  05  | July 2     | NO CLASS THIS WEEK                             |
|  06  | July 9     | Reproducible data analysis in R                |
|  07  | July 16    | Mapping in R, part 1                           |
|  08  | July 23    | Mapping in R, part 2                           |
|  09  | July 30    | Building interactive visualizations            |
