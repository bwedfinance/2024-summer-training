# class_5_small_group_activity
# last updated 2024-07-08 by Krista Kaput 
...
edbuild_mortgage_mn <- edbuild_fy19 |> 
  filter(State == "REPLACE WITH YOUR STATE") |> 
...
# What do you notice about your state? Anything surprising? 
